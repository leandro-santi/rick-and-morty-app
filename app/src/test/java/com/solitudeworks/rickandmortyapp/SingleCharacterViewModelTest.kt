...
class SingleCharacterViewModelTest {
    ...
    fun `When retuning a Character by ID, verify if it is equal the MockCharacter`() {
        ...
        val mockCharacter = CharacterDetail(
        ...
        val viewModel = SingleCharacterViewModel(mockUseCase).apply {
        ...
        coEvery { mockUseCase.getSingleCharacter(1) } returns mockCharacter
    ...
    fun `When retuning a CharacterOne by ID, verify if it is not equal CharacterTwo`() {
        ...
        val mockCharacterOne = CharacterDetail(
            created = "2017-11-04T18:48:46.250Z",
            episode = listOf(
                "https://rickandmortyapi.com/api/episode/1"
            ),
        ...
        val mockCharacterTwo = CharacterDetail(
        ...
        coEvery { mockUseCase.getSingleCharacter(1) } returns mockCharacterOne
